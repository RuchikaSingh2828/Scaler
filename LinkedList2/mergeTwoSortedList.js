...
export function mergeTwoSortedList(A, B) {
  ...
  while (pointerA !== null && pointerB !== null) {
    ...
    current = current.next; // advance tail
  }
  ...
  // Return the real head (next of dummy)
  return dummy.next;
}
...
const mergedHead = mergeTwoSortedList(listA.head, listB.head);
